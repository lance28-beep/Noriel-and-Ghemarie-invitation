...
const timelineEvents: TimelineEvent[] = [
  {
    time: "10:00 A.M.",
    title: "Assembly Time",
    description: "Guests and entourage arrive at Daraga Church for final preparations and seating.",
  ...
  },
  {
    time: "10:15 A.M.",
    title: "Processional",
    description: "The wedding processional begins as we prepare to witness Marzan & Nica's vows.",
    location: siteConfig.ceremony.venue,
    icon: ChurchIcon,
  },
  {
    ...
    description: "The ceremony begins as we celebrate the union of Marzan & Nica.",
    location: siteConfig.ceremony.venue,
    icon: RingsIcon,
  },
  {
  ...
  },
  {
    ...
    description: "Program, toasts, and special moments with Marzan & Nica.",
    location: siteConfig.reception.venue,
    icon: MicrophoneIcon,
  },
  {
