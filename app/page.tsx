...
const Silk = dynamic(() => import("@/components/silk"), { 
  ssr: false,
  loading: () => <div className="w-full h-full bg-gradient-to-b from-primary/10 to-secondary/5" />
})
const GuestList = dynamic(() => import("@/components/sections/guest-list").then(mod => ({ default: mod.GuestList })), { 
  ssr: false,
  loading: () => null
})
        ...
        <div className="relative min-h-screen bg-cloud text-charcoal selection:bg-birch selection:text-nut overflow-hidden font-sans">
          ...
          <main className="relative w-full h-full">
            ...
            <div className={`transition-opacity duration-700 ${appState === AppState.DETAILS ? "opacity-100" : "opacity-0 pointer-events-none"}`}>
              ...
              {enableDecor && appState === AppState.DETAILS && (
